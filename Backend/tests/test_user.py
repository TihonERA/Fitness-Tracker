...
class TestUser:
    ...
    async def test_get_me(self, client: AsyncClient, make_user_data):
        await make_user_data()
    ...
    async def test_get_user(self, client: AsyncClient, make_user_data):
        await make_user_data()
    ...
    async def test_update_user(self, client: AsyncClient, make_user_data):
        await make_user_data()
    ...
    async def test_delete_user(self, client: AsyncClient, make_user_data):
        await make_user_data()
