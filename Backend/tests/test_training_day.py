...
class TestTrainingDayApi:
    ...
    async def test_get_training_day(self, client, make_workout, authorize_user):
    ...
    async def test_create_training_day(self, client, make_workout, authorize_user):
        await authorize_user()
        request_body = {
            "name": "Chest",
            "day_order": 4
    ...
    async def test_update_training_day(self, client, make_workout, authorize_user):
        await authorize_user()
        request_body = {
            "name": "NewName"
        }
    ...
    async def test_delete_training_day(self, client, make_workout, authorize_user):
        await authorize_user()
