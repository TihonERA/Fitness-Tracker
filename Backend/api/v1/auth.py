...
from Backend.schemas.user import UserCreate, UserUpdate, UserUpdatePassword

router = APIRouter(tags=["Authorization Endpoints"], prefix="/auth")
...
async def update_password(
    ...
    data: Annotated[UserUpdatePassword, Body()],
    auth_service: AuthServiceDepends,
):
    return await auth_service.update_password(user_id=user_id, data=data)
